    ...
    protected void initGamemode(SessionScreen screen) {
        ...
        if (this.moduleManager.isActive("duel_types_config")) {
            if (!this.createTypeDialogOpen && !this.deleteWarningOpen) {
                this.addActionButton(screen, "Create Type", mainPanel.x() + 14, mainPanel.y() + 40, 110, "Create a new duel type.", () -> {
            ...
            if (this.contextMenuOpen) {
                this.addActionButton(screen, "Edit", this.contextMenuX, this.contextMenuY, 100, "Edit this duel type.", () -> {
                ...
                ButtonWidget deleteBtn = this.addActionButton(screen, "Delete", this.contextMenuX, this.contextMenuY + 20, 100, "Delete this duel type.", () -> {
                    if (this.contextMenuTarget != null) {
            ...
            if (!this.createKitDialogOpen && !this.kitDeleteWarningOpen) {
                this.addActionButton(screen, "Create Kit", mainPanel.x() + 14, mainPanel.y() + 40, 110, "Create a new custom kit.", () -> {
                ...
                this.addActionButton(screen, "Open Kit Registry", mainPanel.x() + 130, mainPanel.y() + 40, 120, "Browse existing kits.", () -> {
            ...
            if (this.kitContextMenuOpen) {
                this.addActionButton(screen, "Rename", this.kitContextMenuX, this.kitContextMenuY, 100, "Rename this kit.", () -> {
                ...
                ButtonWidget deleteBtn = this.addActionButton(screen, "Delete", this.kitContextMenuX, this.kitContextMenuY + 20, 100, "Delete this kit.", () -> {
                    if (this.kitContextMenuTarget != null) {
        ...
        if (this.createTypeDialogOpen) {
            ...
            this.addActionButton(screen, "Cancel", dialogX + 166, dialogY + 202, 66, "Discard changes.", () -> {
                this.createTypeDialogOpen = false;
                screen.openWorkspaceView(this);
            });
        }
        ...
        if (this.deleteWarningOpen && this.deleteTarget != null) {
            ButtonWidget confirmDeleteBtn = this.addActionButton(screen, "Confirm Delete", dialogX + 14, dialogY + 120, 145, "Permanently delete this duel type.", () -> {
                net.fabricmc.fabric.api.client.networking.v1.ClientPlayNetworking.send(
            ...
            this.addActionButton(screen, "Cancel", dialogX + 166, dialogY + 120, 66, "Cancel deletion.", () -> {
                this.deleteWarningOpen = false;
                this.deleteTarget = null;
                screen.openWorkspaceView(this);
            });
        ...
        if (this.createKitDialogOpen) {
            ...
            this.addActionButton(screen, this.isEditingKit ? "Save Changes" : "Save Kit", dialogX + 14, dialogY + 80, 145, "Save this kit.", () -> {
            ...
            this.addActionButton(screen, "Cancel", dialogX + 166, dialogY + 80, 66, "Discard changes.", () -> {
                this.createKitDialogOpen = false;
                screen.openWorkspaceView(this);
            });
        }
        ...
        if (this.kitDeleteWarningOpen && this.kitDeleteTarget != null) {
            ButtonWidget confirmDeleteBtn = this.addActionButton(screen, "Confirm Delete", dialogX + 14, dialogY + 80, 145, "Permanently delete this kit.", () -> {
                net.fabricmc.fabric.api.client.networking.v1.ClientPlayNetworking.send(
            ...
            confirmDeleteBtn.setMessage(Text.literal("Confirm Delete").formatted(net.minecraft.util.Formatting.RED));
            this.addActionButton(screen, "Cancel", dialogX + 166, dialogY + 80, 66, "Cancel deletion.", () -> {
                this.kitDeleteWarningOpen = false;
                this.kitDeleteTarget = null;
                screen.openWorkspaceView(this);
            });
